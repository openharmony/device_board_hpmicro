...
{
    HPM_IOC->PAD[IOC_PAD_PF01].FUNC_CTL = 0;
    HPM_IOC->PAD[IOC_PAD_PF01].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);

    HPM_IOC->PAD[IOC_PAD_PF02].FUNC_CTL = 0;
    HPM_IOC->PAD[IOC_PAD_PF02].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);

    HPM_IOC->PAD[IOC_PAD_PF05].FUNC_CTL = 0;
    HPM_IOC->PAD[IOC_PAD_PF05].PAD_CTL = IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);
}
